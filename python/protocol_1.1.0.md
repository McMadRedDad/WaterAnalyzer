Qt/C++ frontend communicates with Python backend by requests and responses constructed as JSONs according to this protocol. Blobs are sent through a separate channel using HTTP/2 protocol.
